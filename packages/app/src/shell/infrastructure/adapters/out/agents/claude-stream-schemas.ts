...
const ClaudeAssistantTextSchema = v.object({
...
const ClaudeAssistantThinkingSchema = v.object({
  type: v.literal('assistant'),
...
const ClaudeToolUseSchema = v.object({
...
const ClaudeToolResultSchema = v.object({
  type: v.literal('tool_result'),
  content: v.optional(v.unknown()),
});

const ClaudeResultSchema = v.object({
...
const ClaudeSystemSchema = v.object({
