...
} from '#modules/terminal/application/ports/out/terminal-repository.port';

export function createSqliteTerminalRepository(db: Database): TerminalRepositoryShape {
