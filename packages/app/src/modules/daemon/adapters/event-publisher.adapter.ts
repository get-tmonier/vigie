import type { DomainEvent, EventPublisher } from '#modules/terminal/ports/event-publisher.port';
import type { BrowserEvent } from '#modules/terminal/schemas';
...
export type AppEventPublisher = EventPublisher & {
  subscribeBrowser: (listener: (event: BrowserEvent) => void) => () => void;
};
