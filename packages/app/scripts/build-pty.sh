...
SRC="src/modules/agent-session/infrastructure/adapters/out/pty/native/vigie_pty.c"
OUT_DIR="dist"
mkdir -p "$OUT_DIR"

OS=$(uname -s)

NATIVE_DIR="src/modules/agent-session/infrastructure/adapters/out/pty/native"
